...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/adagio-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13823&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/adagio-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `adagio` can be installed with:

```
conda install adagio
```

It is possible to list all of the versions of `adagio` available on your platform with:
